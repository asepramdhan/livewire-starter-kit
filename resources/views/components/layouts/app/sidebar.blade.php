  ...
  <flux:sidebar sticky stashable class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
    ...
    <flux:navlist variant="outline">
      <flux:navlist.group :heading="__('Menu')" class="grid">
        ...
        <flux:navlist.item icon="chart-bar">{{ __('Investasi') }}</flux:navlist.item>
        <flux:navlist.item icon="siren">{{ __('Dana Darurat') }}</flux:navlist.item>
        <flux:navlist.item icon="wallet">{{ __('Dana Harian') }}</flux:navlist.item>
      </flux:navlist.group>
    </flux:navlist>
